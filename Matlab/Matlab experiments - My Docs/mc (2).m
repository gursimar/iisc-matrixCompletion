...
l_lim=90;     % Missing enteries limit (starting from 1) for the loop 
lrate=0.002;    % learning rate
mc_itr = 25000  % Monti carlo iterations
...
for f=1:mc_itr
	...
	% Approximation matrix for the original matrix
        M_approx_missing = u_approx_missing * v_approx_missing;r=60;    r=60;           % rank approximation (or latent feat       % rank approximation (or latent feat
